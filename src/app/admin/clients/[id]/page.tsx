    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-20 font-sans">
      ...
      <div className="bg-white border-b border-slate-200 px-8 py-4 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link href="/admin/clients" className="flex items-center gap-2 text-slate-400 hover:text-blue-600 transition-all text-[10px] font-black uppercase tracking-widest">
            <ArrowLeftIcon className="h-4 w-4" />
            Retour au répertoire
          </Link>
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 bg-emerald-500 rounded-full animate-pulse"></span>
            <span className="text-[9px] font-black text-slate-400 uppercase tracking-tighter">Dossier Client Actif</span>
          </div>
        </div>
      </div>
